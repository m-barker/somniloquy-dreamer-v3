...
def load_weights(model_path: str, agent: Dreamer):
...
def evaluate_narration_model(env, agent: Dreamer):
    ...
    # T, B, D
    narration = agent._wm.heads["language"].generate(latent_states, agent._wm.vocab, 50)
    intent = agent._wm.heads["language"].generate(imagined_states, agent._wm.vocab, 50)
...
if __name__ == "__main__":
    model_path = "/home/mattbarker/dev/somniloquy-dreamer-v3/logdir/minigrid/latest.pt"
    ...
    evaluate_narration_model(env, agent)
